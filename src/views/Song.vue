...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_messagge: 'please wait.. your comment is updated!!',
      comments: [],
      sort: 1,
    };
  },
  ...
  async created() {
    const snapshotDoc = await songsCollection.doc(this.$route.params.id).get();
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_messagge = 'please wait.. your comment is updated!!';
      ...
      this.comment_alert_messagge = 'comment is updated!!';
