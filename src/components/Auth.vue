...
import AppRegisterForm from './RegisterationForm.vue';
...
export default {
  ...
  /*     ...mapState({
    ...
    ...mapState({ modalAuthShow: (state) => state.auth.modalAuthShow }),
  /*    modalAuthShow() {
      return this.$store.getters.modalAuthShow;
